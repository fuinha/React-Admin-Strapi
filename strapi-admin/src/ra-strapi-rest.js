...
const AUTH_TOKEN = 'Bearer eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJjVjFNZ0N1T1E0RFpjbUVYRTZjMXJiNl9wYWoyWjRtdWRNV0VGZTQ5ZXAwIn0..h1uGns8puKw3YICjl94-Q_dwA0-Lf9CtZUyENDYePrA1faYXT__p_WnfKdjgLkwcxB4fOdWOTXuBYe-oDiQR7Xw7FYDGnkRaI_pIrTQQ_PBaluX7p7ySwuxrYMCrmW68ik2o4GwJh8I-ETWn96K4tvs9N7YVhpTdKujqv_1lfDLg6GpkvWv0rvi49LNpqPIYr72Z2BUVzUA0SQxnhzN9BPciGe2IW7mOhqHXbqjgtAz7KGOkkg-nLCqZzkyc90tGxmKV0AjdPYbYcAdKd9bn4PRBajhXkhT3HCpKJtS25lN6nbV6xIWj07lzOzB598sWMpDN6RiI5OUrfnfmtVHUnQ'
...
export default (apiUrl, httpClient = fetchUtils.fetchJson, uploadFields = []) => {
    ...
    const convertDataRequestToHTTP = (type, resource, params) => {
        ...
        if (!options.headers) {
            options.headers = new Headers({ Authorization: AUTH_TOKEN });
        }
        return { url, options };
    };
